...
* [x] Recherche des outils de supervision
    - [x] link:PROJET_SUPERVISION/recherches/documentation.adoc[Documentation]
    - [x] link:PROJET_SUPERVISION/recherches/inventoring.adoc[Inventaire]
* [x] Etude du système Nagios actuellement installé.
    - [x] Reconnaissance des hotes et services supervisés
    - [x] Liste des sondes, checks installés (link:PROJET_SUPERVISION/nagios-2/config.adoc[Configuration])
* [ ] Etude des solutions envisageables
    - [x] Identification des critères de sélection (link:PROJET_SUPERVISION/recherches/criteres.adoc[Critères])
    - [ ] Tableau comparatif des solutions/critères (link:PROJET_SUPERVION/recherches/comparatif.ado[Comparatif])
